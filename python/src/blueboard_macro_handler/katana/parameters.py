...
_CAPTURED_V400_NOTE = (
    "Read-only Mk I v4.00 effect flag captured on the hardware-qualified KATANA-100 "
    "duplex transport. Production access is limited to exact firmware v4.00; SysEx writes remain disabled."
)
