...
The pre-consolidation tree contained statements that were correct for v0.4.0 but
conflicted with the new v1 decision. Their maintained replacement is the
canonical reference set:

- `agent-docs/reference/05-release-history-and-v1.0.0-checklist.md` preserves
  the release decision and its current gates.
- `agent-docs/reference/04-protocol-evidence-and-hardware-validation.md`
  preserves the state-awareness evidence boundary.
